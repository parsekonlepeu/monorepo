...
export const langageChoice = ["Français", "English", "Spanish"];

export const dateFormatChoice = ["JJ/MM/YYYY", "MM/JJ/YYYY", "YYYY-MM-JJ"];

export const timeFormatChoice = ["13:00", "1:00pm"];

export const defaultTimeChoice = [
  "15 minutes",
  "20 minutes",
  "30 minutes",
  "45 minutes",
...
export const timezone = [
  ...
  },
  {
    ...
    utc: ["America/LosAngeles", "America/Tijuana", "America/Vancouver"],
  },
  {
  ...
  },
  {
    ...
    utc: [
      ...
      "America/Matamoros",
      "America/Menominee",
      "America/NorthDakota/Beulah",
      "America/NorthDakota/Center",
      "America/NorthDakota/New_Salem",
      "America/Rainy_River",
  ...
  },
  {
    ...
    isdst: true,
    text: "(UTC) Casablanca",
    utc: ["Africa/Casablanca", "Africa/ElAaiun"],
  },
  {
    value: "UTC",
    abbr: "UTC",
